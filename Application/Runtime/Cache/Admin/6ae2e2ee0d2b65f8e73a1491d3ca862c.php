...
<head>
    ...
    <meta charset="utf-8"/>
    <title><?php echo ($current['title']); ?>-Onexplorer</title>
            ...
            <?php if(!empty($v["children"])): ?><ul class="submenu">
                    <?php if(is_array($v["children"])): $i = 0; $__LIST__ = $v["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li
                            <?php if(($vv['id'] == $current['id']) OR ($vv['id'] == $current['pid'])): ?>class="active
                                ...
                                "<?php endif; ?>
                        >
                        <a href="<?php if(empty($vv["children"])): echo U($vv['name']); else: ?>
                        #<?php endif; ?>"
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <!-- PAGE CONTENT BEGINS -->
                            <input type="hidden" name="aid" value="<?php echo ($article["artid"]); ?>" id="aid"/>

                            <!--文章分类-->
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">文章分类 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="fenlei"  placeholder="旅游攻略"
                                           class="col-xs-10 col-sm-5"  disabled="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="文章标题"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($article['longtitle']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">文章标题不能为空。</span>
											</span>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">
                                    短(副)标题 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="shortitle"  placeholder="短标题"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($article['shortitle']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">如果设置短标题，将会在IE标题栏显示短标题。</span>
											</span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">
                                    目的地 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="place"  id="place" placeholder="目的地"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($article['place']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">景点名称</span>
											</span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                        <textarea name="description" id="description" placeholder="文章摘要"
                                                  ...
                                                  rows="5"><?php echo ($article['shortcontent']); ?></textarea>
                                    <span class="help-inline col-xs-12 col-sm-7">
