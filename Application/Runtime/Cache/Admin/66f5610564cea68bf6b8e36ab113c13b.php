                        ...
                        <form id="form" method="post" action="<?php echo U('del');?>">
                            <table class="table table-striped table-bordered">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="center"><input class="aids" type="checkbox" name="aids[]" value="<?php echo ($val['id']); ?>"></td>

                                        <td><?php echo ($val['longtitle']); ?></td>
                                        <td><?php echo ($val['artime']); ?></td>
                                        <td><a href="<?php echo U(edit);?>?aid=<?php echo ($val['id']); ?>"><i
                                                class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a
                                                href="javascript:;" val="<?php echo U('del');?>?aids=<?php echo ($val['id']); ?>" class="del"><i
