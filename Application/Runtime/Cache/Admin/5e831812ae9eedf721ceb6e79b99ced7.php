                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <!-- PAGE CONTENT BEGINS -->
                            <input type="hidden" name="aid" value="<?php echo ($article["id"]); ?>" id="aid"/>

                            <!--文章分类-->
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">文章分类 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="fenlei"  placeholder="乐乐交流"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="place"  id="place" placeholder="目的地"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($article['address']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
