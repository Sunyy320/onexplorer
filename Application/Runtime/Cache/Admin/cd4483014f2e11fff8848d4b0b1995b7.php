                        ...
                        <form id="form" method="post" action="<?php echo U('del');?>">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="center">
                                            <?php if($val['uid'] != 1): ?><input class="uids" type="checkbox" name="uids[]"
                                        ...
                                        <td class="grouptd">
                                            <span class="group" val="<?php echo ($val['uid']); ?>"><?php echo ($val['title']); ?>
                                            </span>
                                        ...
                                        <td class="center">
                                            <a href="<?php echo U('edit');?>?uid=<?php echo ($val['uid']); ?>">修改</a>&nbsp;
