        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>?id=<?php echo ($flash["id"]); ?>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 隶属页面 </label>
                                <div class="col-sm-9">

                                    <select class="col-xs-10 col-sm-5" name="belong">
                                        <option value="index" >首页</option>
                                        <option value="strategy" >旅游攻略</option>
                                    </select>
                                    <span class="help-inline col-xs-12 col-sm-7">
                                         <span class="middle">选择所要显示的页面。</span>
                                    </span>
                                </div>
                            </div>
